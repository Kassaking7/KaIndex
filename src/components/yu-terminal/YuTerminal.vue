...
onMounted(() => {
  ...
  if (welcomeTexts?.length > 0) {
    ...
    terminal.writeTextOutput(
      `Welcome to KaIndex, coolest browser index for geeks!` +
        `<a href="//github.com/Kassaking7/KaIndex" target='_blank'> GitHub Open Source</a>`
    );
    terminal.writeTextOutput(
      `Author <a href="//kassakingzyw.com/" target="_blank">Kassaking7</a>` +
